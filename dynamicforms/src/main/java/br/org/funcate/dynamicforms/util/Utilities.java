    ...
    public static void messageDialog(final Context context, final String msg, final Runnable okRunnable) {
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String response) {
                ...
                dialog.setContentView(br.org.funcate.dynamicforms.R.layout.simpledialog);
                TextView text = (TextView) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogtext);
                text.setText(msg);
                try {
                    Button dialogButton = (Button) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogButtonOK);
                    ...
                    Toast.makeText(context, "Error in messageDialog#inPostExecute -- " + msg + " Exception message: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        }.execute((String) null);
    }
...
/*    public class CustomDialog extends Dialog {
        *//**
        ...
        public CustomDialog(Context context, View view) {
            ...
            setContentView(view);
            Drawable drawable = context.getResources().getDrawable(br.org.funcate.dynamicforms.R.drawable.dialog_background);
    ...
    public static void yesNoMessageDialog(final Context context, final String msg, final Runnable yesRunnable,
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String response) {
                try {
                    final Dialog dialog = new Dialog(context);
                    dialog.setContentView(br.org.funcate.dynamicforms.R.layout.yesnodialog);
                    dialog.setCanceledOnTouchOutside(false);
                    dialog.setCancelable(false);
                    TextView text = (TextView) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogtext);
                    text.setText(msg);
                    Button yesButton = (Button) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogButtonOK);
                    ...
                    Button noButton = (Button) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogButtonCancel);
...
/*    *//**
    ...
    *//**
    ...
    public static void inputMessageDialog(final Context context, final String message,
        ...
        final Dialog dialog = new Dialog(context);
        dialog.setContentView(br.org.funcate.dynamicforms.R.layout.inputdialog);
        TextView text = (TextView) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogtext);
        text.setText(message);
        CheckBox checkBox = (CheckBox) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogcheckBox);
        checkBox.setVisibility(View.GONE);
        final EditText editText = (EditText) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogEdittext);
        ...
        Button cancelButton = (Button) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogButtonCancel);
...
/*    *//**
    ...
    public static void inputMessageAndCheckboxDialog(final Context context, final String message,
        ...
        final EditText editText = (EditText) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogEdittext);
        editText.setText(defaultText);
        final CheckBox checkBox = (CheckBox) dialog.findViewById(br.org.funcate.dynamicforms.R.id.dialogcheckBox);
