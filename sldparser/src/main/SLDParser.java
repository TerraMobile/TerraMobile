...
public class SLDParser/* extends Parser*/ {
...
//        this(factory, CommonFactoryFinder.getFilterFactory(GeoTools.getDefaultHints()));
        this(factory, new FilterFactoryImpl());
    }

    public SLDParser(StyleFactory factory, FilterFactory filterFactory) {
        this.ff = new FilterFactoryImpl();
        this.factory = new StyleFactoryOurImpl();
    ...
    protected PolygonSymbolizer parsePolygonSymbolizer(Node root) {
        PolygonSymbolizer symbol = new PolygonSymbolizerImpl();
    ...
    protected Halo parseHalo(Node root) {
	 ...
	 public static void print(InputStream is) throws FileNotFoundException, IOException, SAXException, ParserConfigurationException
	    {
	    	/* SLDParser parser = new SLDParser(new org.geotools.sld.v1_1.SLDConfiguration());

	    	 StyledLayerDescriptor sld = (StyledLayerDescriptor) parser.parse(is);
            ...
            SLDParser parser=new SLDParser(null,is);
...
/*	         Color fill = SLD.color(ps.getFill().getColor());
    ...
    protected SAXParser parser(boolean validate) throws ParserConfigurationException, SAXException {
        ...
        SAXParserFactory pFactory = new SAXParserFactoryImpl();
        ...
        for (Iterator d = this.handler.getConfiguration().allDependencies().iterator(); d.hasNext();) {
