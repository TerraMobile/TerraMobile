...
public class TransactionStateDiff implements State {
     ...
     *
     * @see org.geotools.data.TransactionStateDiff.commit();
     */
    ...
    /**
     * @see org.geotools.data.Transaction.State#addAuthorization(String)
     */
     ...
     *
     * @throws java.io.IOException If the entire diff cannot be writen out
     * @throws org.geotools.data.DataSourceException If the entire diff cannot be writen out
     */
     ...
     *
     * @throws java.io.IOException If typeName is not Manged by this Tansaction State
     */
     ...
     *
     * @throws java.io.IOException If a FeatureRader could not be constucted to record
     *         differences against
     */
