 ...
 * @author Jody Garnett
 *
 * @deprecated Now replaced by {@link org.opengis.referencing.crs.CRSAuthorityFactory}.
 *
 *
 * @source $URL$
 */
public interface CRSAuthoritySpi extends Factory {
     ...
     * @throws java.io.IOException If the encoding should of been parsable but contained an error
     *
     * @deprecated Replaced by {@link org.opengis.referencing.crs.CRSAuthorityFactory#createCoordinateReferenceSystem}.
     */
