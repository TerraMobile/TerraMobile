 ...
 * <p>
 * The implementation makes use of {@link org.geotools.data.sort.MergeSortDumper).
 * 
 * @source $URL$
 */
public class SortedFeatureReader implements SimpleFeatureReader {
     ...
     * {@link java.io.Serializable}, all sorting attributes need to be {@link Comparable}
     * 
     * @param schema
     * @param sortBy
     * @return
     ...
     *        hint {@link org.geotools.factory.Hints#MAX_MEMORY_SORT}
     */
