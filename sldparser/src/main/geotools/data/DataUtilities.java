 ...
 * <ul>
 * <li>{@link #collection} methods: creating/converting a {@link org.geotools.data.simple.SimpleFeatureCollection} from a range of input.</li>
 ...
 * <li>{@link #} setup a FeatureSource wrapper around the provided data</li>
 * </ul>
 * </p>
 * <p>
 ...
 * <ul>
 * <li>{@link #createSubType(org.opengis.feature.simple.SimpleFeatureType, String[])} methods return a modified copy of an origional feature type. Used to cut down an exsiting
 * feature type to reflect only the attributes requested when using {@link org.geotools.data.simple.SimpleFeatureSource#getFeatures(org.opengis.filter.Filter)}.</li>
 * <li>{@link #compare} and {@link #isMatch(org.opengis.feature.type.AttributeDescriptor, org.opengis.feature.type.AttributeDescriptor)} are used to check for types compatible with
 ...
 * <li>{@link #template} and {@link #defaultValue} methods which uses {@link org.opengis.feature.type.AttributeDescriptor#getDefaultValue()} when creating new empty features</li>
 ...
 * <ul>
 * <li>{@link #urlToFile(java.net.URL)} and {@link #fileToURL(java.io.File)} and {@link #getParentUrl(java.net.URL)} used to work with files across platforms</li>
 * <li>{@link #includeFilters} and {@link #excludeFilters} work as a compound {@link java.io.FileFilter} making {@link java.io.File#listFiles} easier to use</li>
 ...
 * </li>{@link #sortComparator}, {@link #resolvePropertyNames} and {@link #mixQueries} are used to prep a {@link org.geotools.data.Query} prior to use</li>
 * </ul>
 * 
...
public class DataUtilities {
    ...
    /** Reverse type map used by {@link #(org.opengis.feature.type.FeatureType)} */
     ...
     * 
     * <p>
     * Comparison is based on {@link org.opengis.feature.type.AttributeDescriptor} - the {@link #isMatch(org.opengis.feature.type.AttributeDescriptor, org.opengis.feature.type.AttributeDescriptor)}
     ...
     * </p>
     * <p>
     * Please note this method will not result in a stable sort if used in a {@link java.util.Comparator}
     ...
     * <p>
     * The {@link #defaultValues(org.opengis.feature.simple.SimpleFeatureType)} method is used to generate
     * the intial values (making use of {@link org.opengis.feature.type.AttributeDescriptor#getDefaultValue()} as required.
     * 
     * @param featureType
     * @param featureID
     ...
     * @deprecated Please {@link org.opengis.feature.type.AttributeDescriptor#getDefaultValue()}
     */
     ...
     * <p>
     * See {@link org.geotools.styling.UserLayer} for example use.
    ...
    /**
     * Checks if the provided iterator implements {@link java.io.Closeable}.
     * <p>
     * Any problems are logged at {@link java.util.logging.Level#FINE}.
     */
    ...
    /**
     * Iteator wrapped around the provided FeatureIterator, implementing {@link java.io.Closeable}.
     * 
     * @see #close(java.util.Iterator)
     ...
     * <li>Geometry.equals( Geometry ) - similar to {@link com.vividsolutions.jts.geom.Geometry#equalsExact(com.vividsolutions.jts.geom.Geometry)}</li>
     * </ul>
     * 
     * @param att
     *            Attribute value
     ...
     * 
     * <p>
     * Where <i>Type</i> is defined by {@link }:
     * <ul>
     ...
     * <p>
     * @see org.geotools.referencing.CRS#lookupEpsgCode(org.opengis.referencing.crs.CoordinateReferenceSystem, boolean) for full search
     * @param crs
     ...
     * <li>Geometry is handled using {@link org.geotools.geometry.jts.WKTReader2}</li>
     ...
     * @throws org.geotools.data.DataSourceException if the information stored is inconsistent with the headered provided
     */
     ...
     * <li>Using {@link org.geotools.util.Converters} to convert the text to the requested value</li>
     * @param descriptor
     * @param rawText
     * @return
     */
    ...
    /**
     * Uses {@link org.geotools.util.Converters} to parse the provided text into the correct values to create a feature.
     * 
     * @param type
     *            FeatureType
     * @param fid
     ...
     * This method handles:
     * <ul>
     * <li>{@link org.opengis.filter.sort.SortBy#NATURAL_ORDER}: As sorting by FeatureID
     * </ul>
     * 
     * @param sortBy
    ...
    /**
     * Takes two {@link org.geotools.data.Query}objects and produce a new one by mixing the restrictions of both of
     * them.
     * 
     * <p>
     ...
     * verification. Client code should always call {@link org.geotools.feature.FeatureCollection#size()}
    ...
    /**
     * Manually count the number of features in a feature collection using using {@link org.geotools.feature.FeatureCollection#features()}.
     * 
     * This implementation is intended for FeatureCollection implementors and test case
     * verification. Client code should always call {@link org.geotools.feature.FeatureCollection#size()}
     * @param collection
     ...
     * This implementation is intended for FeatureCollection implementors and test case
     * verification. Client code should always call {@link org.geotools.feature.FeatureCollection#getBounds()}.
     * 
     * @param iterator
     * @return
     */
    ...
    /**
     * Manually calculates the bounds of a feature collection using {@link org.geotools.feature.FeatureCollection#features()}.
     * <p>
     * This implementation is intended for FeatureCollection implementors and test case
     * verification. Client code should always call {@link org.geotools.feature.FeatureCollection#getBounds()}.
     *  
    ...
    /**
     * Manually visit each feature using {@link org.geotools.feature.FeatureCollection#features()}.
     * <p>
     ...
     * {@link org.geotools.feature.FeatureCollection#accepts(org.opengis.feature.FeatureVisitor, org.opengis.util.ProgressListener)}
     * 
     * @param collection
     * @return bounds of features in feature collection
     */
    ...
    /**
     * Changes the ending (e.g. ".sld") of a {@link java.net.URL}
     * 
     * @param url
     *            {@link java.net.URL} like <code>file:/sds/a.bmp</code> or
     *            <code>http://www.some.org/foo/bar.shp</code>
     * @param postfix
     *            New file extension for the {@link java.net.URL} without <code>.</code>
     * 
     * @return A new {@link java.net.URL} with new extension.
     * 
     * @throws {@link java.net.MalformedURLException} if the new {@link java.net.URL} can not be created.
     */
    ...
    /**
     * The function is supposed to be equivalent to {@link java.io.File}.getParent(). The {@link java.net.URL} is
     * converted to a String, truncated to the last / and then recreated as a new URL.
     * 
     * @throws {@link java.net.MalformedURLException} if the parent {@link java.net.URL} can not be created.
     */
    ...
    /**
     * Extends an {@link java.net.URL}.
     * 
     * @param base
     *            Has to be a {@link java.net.URL} pointing to a directory. If it doesn't end with a
     *            <code>/</code> it will be added automatically.
     * @param extension
     *            The part that will be added to the {@link java.net.URL}
     * 
     * @throws java.net.MalformedURLException
     *             if the new {@link java.net.URL} can not be created.
     */
    ...
    /**
     * Checks that a {@link java.io.File} is a real file, exists and is readable.
     * 
     * @param file
     *            the {@link java.io.File} instance to check. Must not be null.
     * @param logger
     *            an optional {@link java.util.logging.Logger} (can be null) where to log detailed info about the file
    ...
    /**
     * Returns a {@link } obtained by excluding from the first input filter argument,
    ...
    /**
     * Returns a {@link } obtained by adding to the first input filter argument, the
