...
public class CollectionDataStore extends AbstractDataStore {
    ...
    /**
     * @see org.geotools.data.DataStore#getSchema(String)
     */
     ...
     *
     *
     * @throws java.io.IOException If typeName could not be found
     * @throws org.geotools.data.DataSourceException See IOException
     *
     * @see org.geotools.data.AbstractDataStore#getFeatureSource(String)
     */
     ...
     * @see org.geotools.data.AbstractDataStore#getBounds(String,
    ...
    /**
     * @see org.geotools.data.AbstractDataStore#getCount(String, org.geotools.data.Query)
     */
