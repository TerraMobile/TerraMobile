 ...
 * @author dzwiers
 *
 * @see org.geotools.data.DataStoreFinder
 *
 *
 * @source $URL$
 */
public class FileDataStoreFinder {
     ...
     *
     * @throws java.io.IOException If a suitable loader can be found, but it can not be
     ...
     *
     *
     * @see org.geotools.data.FileDataStoreFactorySpi
     * @see org.geotools.data.FileDataStore
     */
