...
public abstract class AbstractFeatureStore extends AbstractFeatureSource
     ...
     *
     * @throws java.io.IOException If modification could not be made
     */
     ...
     * @param filter Identifies features to modify
     *
     * @throws java.io.IOException If we could not modify Feature
     * @throws org.geotools.data.DataSourceException See IOException
     */
     ...
     *
     * @throws java.io.IOException If we encounter a problem encounter writing content
     * @throws org.geotools.data.DataSourceException See IOException
     *
     * @see FeatureStore#addFeatures(FeatureReader)
     */
     ...
     *
     * @throws java.io.IOException if anything goes wrong during replacement
     * @throws org.geotools.data.DataSourceException See IOException
     */
