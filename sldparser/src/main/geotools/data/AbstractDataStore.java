...
//    }
     ...
     *
     * @throws java.io.IOException Subclass may throw IOException
     ...
     * @throws java.io.IOException
     *
     * @throws java.io.IOException if there are errors getting the count
     */
    ...
    /**
     * Delegates to {@link #updateSchema(String, org.opengis.feature.simple.SimpleFeatureType)} with
     * {@code name.getLocalPart()}
     * 
     * @since 2.5
     * @see org.geotools.data.DataAccess#getFeatureSource(org.opengis.feature.type.Name)
    ...
    /**
     * @see org.geotools.data.DataStore#removeSchema(String)
     */
