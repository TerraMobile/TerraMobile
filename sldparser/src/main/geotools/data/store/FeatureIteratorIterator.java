...
/**
 * An {@link java.util.Iterator} which delegates to a {@link org.geotools.feature.FeatureIterator}.
 * 
...
public class FeatureIteratorIterator<F extends Feature> implements Iterator<F> {
	...
	/**
	 * Calls through to {@link org.geotools.feature.FeatureIterator#hasNext()}
	 */
	...
	/**
	 * Calls through to {@link org.geotools.feature.FeatureIterator#next()}
	 */
	public F next() {
