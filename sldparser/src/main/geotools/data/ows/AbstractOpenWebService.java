...
public abstract class AbstractOpenWebService<C extends Capabilities, R extends Object> {
     ...
     * @throws java.io.IOException if there is an error communicating with the server
     * @throws org.geotools.ows.ServiceException if the server responds with an error
     */
    ...
    /**
     * @deprecated use {@link #AbstractOpenWebService(OWSConfig, org.geotools.data.ows.Capabilities)}
     */
     ...
     * @throws java.io.IOException if there is an error communicating with the server, or the XML cannot be parsed
     * @throws org.geotools.ows.ServiceException if the server returns a ServiceException
     */
     ...
     * @throws java.io.IOException if there was a problem communicating with the server
     * @throws org.geotools.ows.ServiceException if the server responds with an exception or returns bad content
     */
