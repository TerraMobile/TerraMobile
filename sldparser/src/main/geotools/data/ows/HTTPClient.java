...
/**
 * Defines the inteface by which an {@link org.geotools.data.ows.AbstractOpenWebService} executes HTTP requests.
 * 
 * @author groldan
 * @see org.geotools.data.ows.HTTPResponse
 * @see org.geotools.data.ows.SimpleHttpClient
 * @see org.geotools.data.ows.AbstractOpenWebService#setHttpClient(org.geotools.data.ows.HTTPClient)
 */
public interface HTTPClient {
     ...
     * @return the {@link org.geotools.data.ows.HTTPResponse} encapsulating the response to the HTTP POST request
     ...
     * @param url
     *            the URL to retrieve
     * @return an {@link org.geotools.data.ows.HTTPResponse} encapsulating the response to the HTTP GET request
     * @throws java.io.IOException
     */
