...
/**
 * Interface by which an {@link org.geotools.data.ows.AbstractOpenWebService} retrieves the contents of an HTTP request
 * issued through its {@link org.geotools.data.ows.HTTPClient}.
 * <p>
 ...
 * the implementations to just close the actual {@link java.io.InputStream} or return the http connection to
 * the connection pool, or any other resource clean up task that needs to be done.
 * 
 * @author groldan
 * @see org.geotools.data.ows.HTTPClient
 */
