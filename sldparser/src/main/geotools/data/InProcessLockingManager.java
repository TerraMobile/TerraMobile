...
public class InProcessLockingManager implements LockingManager {
     ...
     *
     * @throws org.geotools.data.FeatureLockException Indicates a problem with the lock request
     */
     ...
     *
     * @throws org.geotools.data.FeatureLockException When a Transaction  lock is requested
     ...
     *
     * @throws org.geotools.data.FeatureLockException If transaction does not have sufficient
     *         authroization
     */
     ...
     * @param featureLock
     *
     * @throws java.io.IOException If lock could not be released
     */
     ...
     *
     * @throws java.io.IOException If transaction not authorized to refresh authID
     ...
     *
     * @throws java.io.IOException If transaction not authorized to release authID
     * @throws IllegalArgumentException If authID or transaction not provided
     */
     ...
     *
     * @see LockingManager#lockExists(String)
     */
    ...
    class TransactionLock implements Lock, State {
         ...
         *
         * @throws java.io.IOException Not used
         */
