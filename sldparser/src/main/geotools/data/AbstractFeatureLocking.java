...
public abstract class AbstractFeatureLocking extends AbstractFeatureStore
     ...
     *
     * @see FeatureLocking#setFeatureLock(FeatureLock)
     */
     ...
     *
     * @see FeatureLocking#lockFeatures()
     */
     ...
     * @return Number of locked Features
     *
     * @throws java.io.IOException If we could not determine which feature to lock
     *         based on Query
     * @throws UnsupportedOperationException When DataStore does not provide a
     *         LockingManager
     * @throws org.geotools.data.DataSourceException If feature to be locked does not exist
     *
     * @see FeatureLocking#lockFeatures(Query)
     */
     ...
     * @throws java.io.IOException
     *
     * @see FeatureLocking#unLockFeatures()
     */
     ...
     * @throws org.geotools.data.DataSourceException Filter describes an unlocked Feature, or
     *         authorization not held
     *
     * @see FeatureLocking#unLockFeatures(Query)
     */
