 ...
 * provides support for only the most basic factories ({@linkplain org.geotools.referencing.ReferencingFactoryFinder referencing},
 * <cite>etc.</cite>). Many methods thrown an {@link org.geotools.factory.FactoryNotFoundException} in all cases, for
...
public class BasicFactories {
     ...
     * The error message will be given to a {@link org.geotools.factory.FactoryNotFoundException}.
     *
    ...
    /**
     * Returns the {@linkplain org.opengis.feature.type.FeatureTypeFactory feature type factory} singleton.
     * <p>
     ...
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     * 
    ...
    /**
     * Returns the {@linkplain org.opengis.filter.FilterFactory filter factory} singleton.
     * <p>
     * <strong>NOTE:</strong> This method is not yet supported in Geotools.
     * The default implementation thrown an exception in all case.
     *
    ...
    /**
     * Returns the {@linkplain org.opengis.util.NameFactory name factory} singleton.
     * <p>
     * <strong>NOTE:</strong> This method is not yet supported in Geotools.
     * The default implementation thrown an exception in all case.
     *
    ...
    /**
     * Returns the {@linkplain org.opengis.metadata.citation.CitationFactory citation factory} singleton.
     * <p>
     * <strong>NOTE:</strong> This method is not yet supported in Geotools.
     * The default implementation thrown an exception in all case.
     *
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.crs.CRSAuthorityFactory CRS authority factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.crs.CRSFactory CRS factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.cs.CSAuthorityFactory CS authority factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.cs.CSFactory CS factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.datum.DatumAuthorityFactory datum authority factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.datum.DatumFactory datum factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.operation.CoordinateOperationAuthorityFactory coordinate operation authority
     * factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
    ...
    /**
     * Returns the {@linkplain org.opengis.referencing.operation.CoordinateOperationFactory coordinate operation factory} singleton.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.geometry.coordinate.GeometryFactory geometry factory} equiped to build geometries
     * using the given {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system}.
     * <p>
     * <strong>NOTE:</strong> This method is not yet supported in Geotools.
     * The default implementation thrown an exception in all case.
     *
     * @param crs the {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system} the
     *        {@linkplain org.opengis.geometry.coordinate.GeometryFactory geometry factory} should use.
     * @return the requested {@linkplain org.opengis.geometry.coordinate.GeometryFactory geometry factory} or {@code null} if the
     *         {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system} is not supported.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
     */
    ...
    /**
     * Returns the {@linkplain org.opengis.geometry.primitive.PrimitiveFactory primitive factory} equiped to build primitives
     * using the given {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system}.
     * <p>
     * <strong>NOTE:</strong> This method is not yet supported in Geotools.
     * The default implementation thrown an exception in all case.
     *
     * @param crs the {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system} the
     *        {@linkplain org.opengis.geometry.primitive.PrimitiveFactory primitive factory} should use.
     * @return the requested {@linkplain org.opengis.geometry.primitive.PrimitiveFactory primitive factory} or {@code null} if the
     *         {@linkplain org.opengis.referencing.crs.CoordinateReferenceSystem coordinate reference system} is not supported.
     *
     * @throws org.geotools.factory.FactoryNotFoundException if no factory was found for the requested type.
     * @throws org.geotools.factory.FactoryRegistryException if the factory can't be obtained for an other reason.
