...
public abstract class GeometryFilterImpl extends BinaryComparisonAbstract
    ...
    protected GeometryFilterImpl(Expression e1,
            Expression e2, MatchAction matchAction) {
        super(e1, e2);
        this.matchAction = matchAction;
    }
    ...
    public String toString() {
        ...
        Expression leftGeometry = getExpression1();
        Expression rightGeometry = getExpression2();
