...
public class LikeFilterImpl extends AbstractFilter implements PropertyIsLike {
    ...
    public LikeFilterImpl(Expression expr, String pattern, String wildcardMulti,
     ...
     *  {@link org.opengis.filter.PropertyIsLike#setExpression(org.opengis.filter.expression.Expression)}
     ...
     * 
     * @deprecated use one of 
     *  {@link org.opengis.filter.PropertyIsLike#setLiteral(String)}
     *  {@link org.opengis.filter.PropertyIsLike#setWildCard(String)}
     *  {@link org.opengis.filter.PropertyIsLike#setSingleChar(String)}
     *  {@link org.opengis.filter.PropertyIsLike#setEscape(String)}
     */
