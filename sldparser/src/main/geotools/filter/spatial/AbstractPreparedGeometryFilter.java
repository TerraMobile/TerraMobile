 ...
 * field {@link #literals} contains the {@link org.geotools.filter.spatial.AbstractPreparedGeometryFilter.Literals} enumerated value that indicates if:
 * </p>
 * <ul>
 * <li><strong>NEITHER</strong> ({@link org.geotools.filter.spatial.AbstractPreparedGeometryFilter.Literals#NEITHER) of the expressions are literal and is a JTS Geometry (also non-null)</li>
 * <li><strong>BOTH</strong> ({@link org.geotools.filter.spatial.AbstractPreparedGeometryFilter.Literals#BOTH}) expressions are literals and is a JTS Geometry (also non-null)</li>
 * <li>the <strong>LEFT</strong> ({@link org.geotools.filter.spatial.AbstractPreparedGeometryFilter.Literals#LEFT}) expression (Expression1) is a literal and is a JTS Geometry (also non-null)</li>
 * <li>or the <strong>RIGHT</strong> ({@link org.geotools.filter.spatial.AbstractPreparedGeometryFilter.Literals#RIGHT}) expression (Expression2) is a literal and is a JTS Geometry (also non-null)</li>
 * </ul>
 * <p>
 * If <strong>BOTH</strong> of the expressions are literals then a cached value is generated by calling {@link #basicEvaluate(com.vividsolutions.jts.geom.Geometry, com.vividsolutions.jts.geom.Geometry)}.
 * </p>
 * <p>
 * The method {@link #basicEvaluate(com.vividsolutions.jts.geom.Geometry, com.vividsolutions.jts.geom.Geometry)} is required to be implemented so that a cached value can be generated in the case
...
public abstract class AbstractPreparedGeometryFilter extends GeometryFilterImpl {
    ...
    protected enum Literals {
        /**
         * Neither Expression are {@link org.opengis.filter.expression.Literal}s
         */
        NEITHER,
        /**
         * Expression2 the "right" geometry is a {@link org.opengis.filter.expression.Literal}
         */
        RIGHT, 
        /**
         * Expression1 the "left" geometry is a {@link org.opengis.filter.expression.Literal}
         */
        LEFT,
        /**
         * Both expressions are {@link org.opengis.filter.expression.Literal} expressions
         */
        BOTH;
    ...
    /**
     * Indicates which expressions are {@link org.opengis.filter.expression.Literal}s
     */
    protected Literals literals;
    /**
     * The PreparedGeometry for the left Geometry.  Null if the left geometry is not a 
     * {@link org.opengis.filter.expression.Literal}
     */
