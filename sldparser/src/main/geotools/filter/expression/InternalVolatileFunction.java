...
/**
 * A base class functions (i.e. anonymous inner classes) that are both {@link org.opengis.filter.expression.VolatileFunction
 * volatile} (i.e. explicitly stating evaluation needs to happen for each object in the collection
 * being traversed) and {@link org.opengis.filter.expression.InternalFunction internal} (i.e. are not subject of SPI lookup, such
...
public abstract class InternalVolatileFunction extends FunctionImpl implements InternalFunction,
     ...
     * <p>
     * A subclass that do expect {@link org.opengis.filter.expression.Expression} parameters shall override this method and return
