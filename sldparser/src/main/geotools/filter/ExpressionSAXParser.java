...
public class ExpressionSAXParser {
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException If there are problems creating
     *         expressions.
     */
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException If there are problems with filter
     *         constrcution.
     *
     ...
     *         thrown otherwise.
     *
     * @throws org.geotools.filter.IllegalFilterException if the current expression is not math,
