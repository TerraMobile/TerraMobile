...
public abstract class FunctionExpressionImpl
    extends DefaultExpression implements FunctionExpression {
    ...
    /**
     * @see org.opengis.filter.expression.Expression#accept(org.opengis.filter.expression.ExpressionVisitor, Object)
     */
     ...
     * @see org.geotools.filter.FunctionImpl#functionName(String, String, String...)
     */
