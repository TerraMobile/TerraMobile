...
/**
 * Provides access to certain transaction state for the {@link org.geotools.filter.visitor.PostPreProcessFilterSplittingVisitor}
 * and {@link org.geotools.filter.visitor.CapabilitiesFilterSplitter}. This is only required if the transaction is kept on the
...
public interface ClientTransactionAccessor {
	 ...
	 * {@link org.opengis.filter.Filter#EXCLUDE} if the attribute path is not supported/encodable to the backend
