 ...
 * hierarchy.
 * <p>
 * Methods are grouped by the {@link org.opengis.filter.BinaryLogicOperator}, {@link org.opengis.filter.BinaryComparisonOperator},
 *  {@link org.opengis.filter.spatial.BinarySpatialOperator}, and {@link org.opengis.filter.temporal.BinaryTemporalOperator} and subclasses should
 *  implement:
 *  <ul>
 *    <li>{@link #visit(org.opengis.filter.BinaryLogicOperator, Object)}
 *    <li>{@link #visit(org.opengis.filter.BinaryComparisonOperator, Object)}
 *    <li>{@link #visit(org.opengis.filter.spatial.BinarySpatialOperator, Object)}
 *    <li>{@link #visit(org.opengis.filter.temporal.BinaryTemporalOperator, Object)
 *  </ul>
 *  For visitors looking for a base class that simply stubs out the various visit methods should use
 *  {@link org.geotools.filter.visitor.DefaultFilterVisitor} instead.
 * </p>
 * 
