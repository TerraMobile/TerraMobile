 ...
 * <ul>
 * <li>simplifies out {@link org.opengis.filter.Filter#INCLUDE} and {@link org.opengis.filter.Filter#EXCLUDE} in logical expressions</li>
 ...
 * </ul>
 * <p>
 * FID filter validation is meant to wipe out non valid feature ids from {@link org.opengis.filter.Id} filters. This is
 ...
 * abstracted out to the {@link org.geotools.filter.visitor.SimplifyingFilterVisitor.FIDValidator} interface so when a DataStore is about to send a query
 ...
 * set a {@link org.geotools.filter.visitor.SimplifyingFilterVisitor.FIDValidator} through the {@link #setFIDValidator(org.geotools.filter.visitor.SimplifyingFilterVisitor.FIDValidator)} method.
 * </p>
 * 
...
public class SimplifyingFilterVisitor extends DuplicatingFilterVisitor {
    ...
    /**
     * Defines a simple means of assessing whether a feature id in an {@link org.opengis.filter.Id} filter is
    ...
    /**
     * A 'null-object' fid validator that assumes any feature id in an {@link org.opengis.filter.Id} filter is valid
     */
    ...
    /**
     * Uses the current {@link org.geotools.filter.visitor.SimplifyingFilterVisitor.FIDValidator} to wipe out illegal feature ids from the returned
     * filters.
     * 
     * @return a filter containing only valid fids as per the current {@link org.geotools.filter.visitor.SimplifyingFilterVisitor.FIDValidator}, may be
     *         {@link org.opengis.filter.Filter#EXCLUDE} if none matches or the filter is already empty
     */
    @Override
     ...
     * implements the {@link org.opengis.filter.expression.VolatileFunction} interface, subclasses can override
     * 
     * @param function
     * @return
     */
