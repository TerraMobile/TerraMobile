...
/**
 * Utility class used by {@link org.geotools.filter.visitor.SimplifyingFilterVisitor} to combine range based filters. This class
        ...
        for (Filter f : filters) {
            if (f instanceof PropertyIsBetween) {
                ...
                if (logic instanceof org.opengis.filter.And) {
                    subCombiner = new And(ff, featureType, children);
                } else {
                    subCombiner = new Or(ff, featureType, children);
                }
