 ...
 * </p>
 * <p>
 * Since GeoTools 8.0, the {@link org.geotools.filter.visitor.ClientTransactionAccessor} interface can also be used to instruct
 * the splitter that a filter referencing a given {@link org.opengis.filter.expression.PropertyName} can't be encoded by the
 * back-end, by returning {@link org.opengis.filter.Filter#EXCLUDE} in
 * {@link org.geotools.filter.visitor.ClientTransactionAccessor#getUpdateFilter(String) getUpdateFilter(String)}. This is so
...
public class CapabilitiesFilterSplitter implements FilterVisitor, ExpressionVisitor {
    ...
    /**
     * @see org.opengis.filter.FilterVisitor#visit(org.opengis.filter.IncludeFilter, Object)
     * 
     * @param filter
     *            the {@link org.opengis.filter.Filter} to visit
     */
    ...
    /**
     * @see org.opengis.filter.FilterVisitor#visit(org.opengis.filter.ExcludeFilter, Object)
     * 
     * @param filter
     *            the {@link org.opengis.filter.Filter} to visit
     */
    ...
    /**
     * @see org.opengis.filter.FilterVisitor#visit(org.opengis.filter.PropertyIsBetween, Object) NOTE: This method is extra documented as
