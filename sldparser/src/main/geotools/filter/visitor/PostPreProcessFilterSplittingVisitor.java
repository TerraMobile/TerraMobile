 ...
 *
 * @source $URL$
 * @deprecated use {@link org.geotools.filter.visitor.CapabilitiesFilterSplitter} instead for geoapi FilterCapabilities
 */
public class PostPreProcessFilterSplittingVisitor implements FilterVisitor, ExpressionVisitor {
         ...
         * by something with the given {@link org.geotools.filter.FilterCapabilities}
         */
         ...
         * 
         * @param filter the {@link org.opengis.filter.Filter} to visit
         */
        ...
        /**
         * @see org.opengis.filter.FilterVisitor#visit(org.opengis.filter.PropertyIsBetween, Object)
         * 
