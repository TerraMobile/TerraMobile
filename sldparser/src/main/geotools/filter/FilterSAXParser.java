...
public class FilterSAXParser {
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException Filter is illegal.
     */
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException if the expression does not match what the
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException If called before the filter is in a
     *         complete state.
     */
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException if the filter type is not recognized.
     */
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException if the distance string can not be
