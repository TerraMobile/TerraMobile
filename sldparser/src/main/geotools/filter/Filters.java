...
public class Filters {
     ...
     * </code>
     * </pre>
     * @see org.geotools.filter.ExpressionType
     * @param experssion
    ...
    public static short getFilterType( Filter filter ){
        ...
        if( filter == Filter.EXCLUDE ) return FilterType.ALL;
        if( filter == Filter.INCLUDE ) return FilterType.NONE;
