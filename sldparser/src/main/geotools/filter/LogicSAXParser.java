...
public class LogicSAXParser {
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException if filter type does not match  declared
     *         type.
     */
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException If the end message can't be processed in
     *         this state.
     */
     // logic types are AND=2, OR=1, NOT=3
     ...
     *
     * @throws org.geotools.filter.IllegalFilterException if the filter is not complete.
     */
