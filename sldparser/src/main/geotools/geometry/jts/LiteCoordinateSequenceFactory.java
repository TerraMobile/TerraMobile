...
public class LiteCoordinateSequenceFactory implements CoordinateSequenceFactory {
    ...
    /**
     * Cast to a {@link org.geotools.geometry.jts.LiteCoordinateSequence}
     * <p>
     * This method first checks if <tt>cs</tt> is an instanceof {@link org.geotools.geometry.jts.LiteCoordinateSequence}, if
     * it is, itself is returned. If not, <tt>cs</tt> is cloned into a new
     * {@link org.geotools.geometry.jts.LiteCoordinateSequence}
     * </p>
     * <p>
     * If cs is null, null is returned.
     * </p>
     * 
     * @param cs The source {@link com.vividsolutions.jts.geom.CoordinateSequence}. Can be null.
