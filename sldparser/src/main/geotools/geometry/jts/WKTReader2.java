 ...
 * @source $URL$
 * @version 1.7
 * @see com.vividsolutions.jts.io.WKTWriter
 */
public class WKTReader2 extends WKTReader {
    ...
    /**
     * Creates a reader that creates objects using the default {@link com.vividsolutions.jts.geom.GeometryFactory}.
     */
    public WKTReader2() {
    ...
    /**
     * Creates a reader that creates objects using the given {@link com.vividsolutions.jts.geom.GeometryFactory}.
     * 
    ...
    /**
     * Reads a Well-Known Text representation of a {@link com.vividsolutions.jts.geom.Geometry} from a {@link String}.
     * 
     * @param wellKnownText
    ...
    /**
     * Reads a Well-Known Text representation of a {@link com.vividsolutions.jts.geom.Geometry} from a {@link java.io.Reader}.
     * 
     *@param reader
     ...
     * @throws com.vividsolutions.jts.io.ParseException if the coordinates used to create the <code>LinearRing</code> do not
     ...
     * @throws java.io.IOException if an I/O error occurs
     * @throws com.vividsolutions.jts.io.ParseException if an unexpected token was encountered
     */
