...
public class JTSFactoryFinder extends FactoryFinder {
    ...
    /**
     * Returns the first implementation of {@link com.vividsolutions.jts.geom.GeometryFactory}, a new one is created if
     * possible or an exception is thrown otherwise.
     *
     * @return The first geometry factory available on the classpath
     * @throws org.geotools.factory.FactoryRegistryException if no implementation was found or can be created for the
     *         {@link com.vividsolutions.jts.geom.GeometryFactory} category.
     */
    ...
    private static final class Registry extends FactoryCreator {
         ...
         * {@link com.vividsolutions.jts.geom.GeometryFactory} uses the required {@link com.vividsolutions.jts.geom.CoordinateSequenceFactory}
         * and {@link com.vividsolutions.jts.geom.PrecisionModel}.
         *
        ...
        /**
         * Checks if an actual {@link com.vividsolutions.jts.geom.GeometryFactory} property matches the given hint.
         *
         * @param actual The geometry factory property, either a {@link com.vividsolutions.jts.geom.CoordinateSequenceFactory}
         *               or a {@link com.vividsolutions.jts.geom.PrecisionModel} concrete implementation.
