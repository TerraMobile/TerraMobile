...
/**
 * A builder for {@link com.vividsolutions.jts.geom.Geometry} objects. Primarily intended to
 * support fluent programming in test code.
 * <p>
 * Features include:
 * <ul>
 * <li>Both 2D and 3D coordinate dimensions are supported
 * (assuming the provided {@link com.vividsolutions.jts.geom.CoordinateSequenceFactory} supports them)
...
public class GeometryBuilder {
    ...
    /**
     * Create a new instance using the default {@link com.vividsolutions.jts.geom.GeometryFactory}.
     */
