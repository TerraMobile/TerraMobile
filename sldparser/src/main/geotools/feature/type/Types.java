...
//                }
    ...
    /**
     * Takes a prefixed attribute name and returns an {@link org.opengis.feature.type.Name} by looking which namespace belongs the prefix to in
     ...
     * @param name
     * @return
     * @deprecated use {@link #toTypeName(javax.xml.namespace.QName}
     */
     ...
     * 
     * @throws org.geotools.feature.IllegalAttributeException In the event that content violates any restrictions specified by the attribute.
     */
