 ...
 * geometric attribute ({@link org.opengis.feature.type.GeometryType}) added will be resulting default.
...
public class SimpleFeatureTypeBuilder {
     ...
     * <p>
     * The supplied coordinate reference is a "default" only used if geometric attributes are later
     * added to the type without specifying their coordinate reference system.
     * <p>
	 ...
	 * 
	 * @see {@link #addBinding(org.opengis.feature.type.AttributeType)}.
	 */
     ...
     * </p>
     * Example: <code> builder.crs( DefaultGeographicCRS.WGS84 ).add( "geom", Polygon.class )</code>
     * <p>
     * This value is reset after a call to {@link #add(String, Class)}
     * </p>
     */
     ...
     * {@link #addBinding(org.opengis.feature.type.AttributeType)},{@link #addBindings(org.opengis.feature.type.Schema)}, or
     * {@link #setBindings(org.opengis.feature.type.Schema)}.
     * </p>
     * <p>
    ...
    /**
     * Creates a new set instance, this default implementation returns {@link java.util.HashSet}.
     */
    ...
    /**
     * Creates a new list instance, this default impelementation returns {@link java.util.ArrayList}.
     */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * Creates a new map instance, this default implementation returns {@link java.util.HashMap}
     */
    @SuppressWarnings("rawtypes")
