...
public class SimpleFeatureBuilder {
    ...
    public static String createDefaultFeatureId() {
        ...
        return "fid-" + UUID.randomUUID().toString().replace(':', '_');
    }
    /**
     ...
     * {@link org.geotools.feature.simple.SimpleFeatureBuilder#retype(org.opengis.feature.simple.SimpleFeature, org.geotools.feature.simple.SimpleFeatureBuilder)} instead.
     * <p>
