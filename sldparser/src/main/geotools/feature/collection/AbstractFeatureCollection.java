...
/**
 * Implement a feature collection just based on provision of an {@link java.util.Iterator}.
 * <p>
 ...
 * <ul>
 * <li>{@link #features()}: makes use of {@link org.geotools.feature.collection.DelegateSimpleFeatureIterator} (if needed) to wrap your iterator up as a SimpleFeatureIterator for
 * public use.</li>
 * </ul>
 * This is the origional implementation of FeatureCollection and is recommended
 * when presenting {@link java.util.Collection} classes as a FeatureCollection.
 * 
...
public abstract class AbstractFeatureCollection implements SimpleFeatureCollection {
     ...
     * is taken to call the {@link org.geotools.feature.FeatureIterator#close()} internally, however
