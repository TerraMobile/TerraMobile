 ...
 * use of parent {@link org.geotools.data.simple.SimpleFeatureCollection#features()}
 * and provided Filter.
 * <p>
 * This is only a reasonable implementation and is not optimal. It is recommended
 * that implementors construct a new {@link org.geotools.data.Query} and use {@link org.geotools.data.simple.SimpleFeatureSource#getFeatures(org.geotools.data.Query)}.
 * 
