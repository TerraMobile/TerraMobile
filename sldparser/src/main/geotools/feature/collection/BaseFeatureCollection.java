...
/**
 * Implement a feature collection just based on provision of a {@link org.geotools.feature.FeatureIterator}.
 * <p>
 * This implementation asks you to implement:
 * <ul>
 * <li>{@link #features()}</li>
 * <li>
 * This is the direct decentent of the origional {@link org.geotools.feature.collection.AbstractFeatureCollection}
...
public abstract class BaseFeatureCollection<T extends FeatureType, F extends Feature> implements FeatureCollection<T,F> {
     ...
     * <p>
     * Note that {@link org.geotools.feature.FeatureIterator<F>#close()} is available to clean up
     ...
     * {@link org.geotools.data.store.FilteringFeatureCollection}. Subclasses might want to override this in case the filter
