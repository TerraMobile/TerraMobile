...
/**
 * A visitor that can limit the features that can be visited (for example to
 * implement startOffset, maxFeatures pagination).
 *
 * @author Mauro Bartolomeoli (mauro.bartolomeoli at geo-solutions.it)
 *
 * @see org.opengis.feature.FeatureVisitor
 * @since 12.x
 *
 *
 * @source $URL$
